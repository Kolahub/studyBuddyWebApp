...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen" data-testid="landing-page">
      {/* Header */}
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="flex flex-col gap-4">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight">
                Learn at <span className="text-primary">your own pace</span>,
                master any subject
              </h1>
              <p className="text-xl text-muted-foreground max-w-[600px]">
                Study Buddy adapts to your learning style, providing
                personalized content and recommendations to help you succeed.
              </p>
                ...
                <div className="w-full max-w-[80%] aspect-video bg-card rounded-lg shadow-lg border flex items-center justify-center">
                  <div className="text-center p-6">
                    ...
                    <p className="text-muted-foreground">
                      Engaging content that adapts to your pace
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="text-center max-w-[800px] mx-auto mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Study Buddy is an adaptive learning platform that tailors
              educational content to your unique learning pace, helping you
              master concepts more effectively.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-card rounded-lg p-6 border shadow-sm">
              ...
              <p className="text-muted-foreground">
                Our system classifies your learning pace and adjusts content
                difficulty to match your needs.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border shadow-sm">
              ...
              <p className="text-muted-foreground">
                Engage with dynamic slides and quizzes designed to reinforce key
            ...
            <div className="bg-card rounded-lg p-6 border shadow-sm">
              ...
              <p className="text-muted-foreground">
                ...
                to focus your learning effectively.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="how-it-works" className="py-20 bg-muted">
        <div className="container">
          <div className="text-center max-w-[800px] mx-auto mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Our three-step process adapts to your learning style to provide
          ...
          <div className="grid lg:grid-cols-3 gap-8 relative">
            ...
            <div className="relative z-10">
              <div className="bg-background rounded-lg p-8 border shadow-sm h-full">
                ...
                <p className="text-muted-foreground text-center mb-4">
                  Take quizzes to help us understand your current knowledge
            ...
            <div className="relative z-10">
              <div className="bg-background rounded-lg p-8 border shadow-sm h-full">
                ...
                <p className="text-muted-foreground text-center mb-4">
                  Our system classifies your learning pace as Slow, Moderate, or
                  Fast based on your performance.
                </p>
                <div className="flex justify-center">
            ...
            <div className="relative z-10">
              <div className="bg-background rounded-lg p-8 border shadow-sm h-full">
                ...
                <p className="text-muted-foreground text-center mb-4">
                  Receive tailored content and recommendations optimized for
                  your learning style.
                </p>
                <div className="flex justify-center">
      ...
      <section className="py-20 bg-background">
        <div className="container">
          <div className="text-center max-w-[800px] mx-auto mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Study Buddy helps you learn more effectively and efficiently with
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Content that adapts to your specific learning pace, ensuring
                  you're neither overwhelmed nor bored.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Smart suggestions for what to study next based on your
                  performance and learning classification.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Interactive slides and quizzes that make learning more
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-card rounded-lg p-6 border shadow-sm">
              ...
              <p className="text-muted-foreground">
                "Study Buddy helped me understand complex programming concepts
                at my own pace. The personalized recommendations were exactly
            ...
            <div className="bg-card rounded-lg p-6 border shadow-sm">
              ...
              <p className="text-muted-foreground">
                "The adaptive learning system recognized that I needed more time
                with calculus concepts but could move quickly through algebra.
                It's like having a tutor who really knows you."
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border shadow-sm">
              ...
              <p className="text-muted-foreground">
                "I was struggling with certain biology concepts, but Study Buddy
                identified my learning pace and provided content that finally
                made everything click. My grades have improved significantly!"
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="max-w-[800px] mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-primary-foreground/80">
              Join thousands of students who are learning at their own pace and
